...
def compute_ar(pred_boxes, gt_boxes, list_iou_thresholds=None):
    """Compute AR over a range og IoU thresholds. Default range is 0.5-0.95."""
    ...
    AUC = 2 * (metrics.auc(list_iou_thresholds, avg_rec))
    return AUC
