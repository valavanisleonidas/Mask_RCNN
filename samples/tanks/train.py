...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 tanks.py train --dataset=/path/to/tanks/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 tanks.py train --dataset=/path/to/tanks/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 tanks.py train --dataset=/path/to/tanks/dataset --weights=imagenet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        ...
                        help='Directory of the tank dataset')
